...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { text: 'Candidate Database', icon: <AssessmentIcon />, path: '/admin/candidate-database' },
    { text: 'Job Applications', icon: <ListAltIcon />, path: '/admin/job-applications' },
    { text: 'Matching Engine', icon: <CompareIcon />, path: '/admin/matching-engine' },
    { text: 'Analytics', icon: <AnalyticsIcon />, path: '/admin/analytics' },
    { text: 'Pipeline Health', icon: <TrendingUpIcon />, path: '/admin/pipeline-analytics' },
  ];
      ...
      >
        <Toolbar>
          ...
          <Menu
            ...
            onClose={handleClose}
          >
            <MenuItem onClick={() => { handleClose(); setProfileCardOpen(true); }}>
              Profile
            </MenuItem>
